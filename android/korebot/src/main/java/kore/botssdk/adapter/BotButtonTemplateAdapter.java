...
public class BotButtonTemplateAdapter extends BaseAdapter {
    ...
    String activeBgColour, activeTextColor, buttonBorderColor;
    String disabledBgColour, disabledTextColor;
    ...
    public BotButtonTemplateAdapter(@NonNull Context context) {
        ...
        activeBgColour = sharedPreferences.getString(BotResponse.BUTTON_ACTIVE_BG_COLOR, "#" + Integer.toHexString(ContextCompat.getColor(context, R.color.colorPrimary)));
        disabledBgColour = sharedPreferences.getString(BotResponse.BUTTON_INACTIVE_BG_COLOR, "#" + Integer.toHexString(ContextCompat.getColor(context, R.color.meetingsDisabled)));
        activeTextColor = sharedPreferences.getString(BotResponse.BUTTON_ACTIVE_TXT_COLOR, "#" + Integer.toHexString(ContextCompat.getColor(context, R.color.white)));
        disabledTextColor = sharedPreferences.getString(BotResponse.BUTTON_INACTIVE_TXT_COLOR, "#" + Integer.toHexString(ContextCompat.getColor(context, R.color.txtFontBlack)));
        buttonBorderColor = sharedPreferences.getString(BotResponse.BUTTON_BORDER_COLOR, "#" + Integer.toHexString(ContextCompat.getColor(context, R.color.color_ededef)));
    ...
    private void initializeViewHolder(View view) {
        ...
        ((GradientDrawable) viewHolder.botItemButton.getBackground()).setColor(isEnabled ? Color.parseColor(activeBgColour) : Color.parseColor(disabledBgColour));
        ((GradientDrawable) viewHolder.botItemButton.getBackground()).setStroke((int) (2 * dp1), Color.parseColor(buttonBorderColor));
        viewHolder.botItemButton.setTextColor(isEnabled ? Color.parseColor(activeTextColor) : Color.parseColor(disabledTextColor));
