...
@interface KREAttributedTextView()<UIGestureRecognizerDelegate>
...
@implementation KREAttributedTextView
...
- (void)setString:(NSString *)sString withWidth:(CGFloat)width
{
    [_touchableWords removeAllObjects];
    [_touchableWordsType removeAllObjects];
    [_touchableLocations removeAllObjects];
...
- (void) setHTMLString:(NSString *)sString withWidth:(CGFloat)width
{
    ...
    originalString = [originalString stringByReplacingOccurrencesOfString:@"****"
                                         withString:@"************"];
    originalString = [originalString stringByReplacingOccurrencesOfString:@"_*"
                                         withString:@"$"];
    originalString = [originalString stringByReplacingOccurrencesOfString:@"*_"
                                         withString:@"$"];
    
    NSString *string = [KREUtilities getHTMLStrippedStringFromString:originalString];
