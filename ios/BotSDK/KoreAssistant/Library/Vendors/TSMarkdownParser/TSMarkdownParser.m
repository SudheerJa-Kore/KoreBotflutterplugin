...
//                                                        [link stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
    ...
    [defaultParser addUnderlineParsingWithFormattingBlock:^(NSMutableAttributedString *attributedString, NSRange range) {
        weakParser.isItalicBold = false; //true
    ...
    [defaultParser addStrongParsingWithFormattingBlock:^(NSMutableAttributedString *attributedString, NSRange range) {
        //
        if (weakParser.isItalicBold == true){
    ...
    /* Bold Italic parsing */
    [defaultParser addBoldItalicParsingWithFormattingBlock:^(NSMutableAttributedString *attributedString, NSRange range) {
        [attributedString addAttributes:weakParser.emphasisAttributes range:range];
    }];
...
static NSString *const TSMarkdownItalicBoldRegex     = @"(\\$)(.+?)(\\1)";
...
- (void)addBoldItalicParsingWithFormattingBlock:(void(^)(NSMutableAttributedString *attributedString, NSRange range))formattingBlock {
    [self addEnclosedParsingWithPattern:TSMarkdownItalicBoldRegex formattingBlock:formattingBlock];
}
