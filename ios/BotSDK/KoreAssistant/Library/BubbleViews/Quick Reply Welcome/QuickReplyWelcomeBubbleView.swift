...
class QuickReplyWelcomeBubbleView: BubbleView {
    ...
    override func initialize() {
       ...
       // UserDefaults.standard.set(false, forKey: "SliderKey")
        ...
        self.cardView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-0-[tileBgv]-10-[maskview]|", options: [], metrics: nil, views: views))
        ...
        if (components.count > 0) {
            ...
            if (component.componentDesc != nil) {
                if ((component.componentDesc) != nil) {
                    ...
                    if (jsonObject["text"] as? String) != nil{
...
extension QuickReplyWelcomeBubbleView : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.layer.borderColor = textColor.cgColor
        cell.layer.borderWidth = 1.5
        cell.layer.cornerRadius = 8
        let bgColor =  bubbleViewBotChatButtonBgColor
