...
public final class DropDown: UIView {
	...
	*/
     ...
     */
	public var cellNib = UINib(nibName: "DropDownCell", bundle: KREResourceLoader.shared.resourceBundle()) {
		didSet {
...
//kk	tableViewContainer.layer.shadowColor = shadowColor.cgColor
