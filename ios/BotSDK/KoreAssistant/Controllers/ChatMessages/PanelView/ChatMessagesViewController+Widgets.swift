...
class KREWidgetViewControllerDelegate: NSObject, KREGenericWidgetViewDelegate {
    ...
    func widgetActionUi(component: Any) {
        ...
        ActionSheet.show(viewController: viewController, title: title, message: "", actions: actions, panels: nil, widget: nil) { [weak self] (index, action) in
    ...
    func widgetActionUiForCommonWidget(component: Any, panel: KREPanelItem?, widget: KREWidget?) {
        ...
        ActionSheet.show(viewController: navigationController, title: title, message: "", actions: actions, panels: panel, widget: widget) { [weak self] (index, action)  in
            if index == actionString.count {
                print("Cancel")
            } else {
    ...
    func populateActions(_ actions: [KREAction]?, in widget: KREWidget?, in panel: KREPanelItem?) {
        ...
        ActionSheet.show(viewController: navigationController, title: nil, message: nil, actions: alertActions, panels: panel, widget: widget) { [weak self] (index, action)  in
...
// MARK: - ActionSheet
class ActionSheet {
    static func show(viewController: UIViewController, title: String?, message: String?, actions: [(String, UIAlertAction.Style, KREAction?)], panels: KREPanelItem?, widget: KREWidget?, completion: @escaping (_ index: Int, _ action: KREAction?) -> Void) {
