    ...
    public func checkAudioRecordPermission(_ block:(() -> Void)?) {
        ...
        SFSpeechRecognizer.requestAuthorization { [weak self] (authStatus) in
            ...
            OperationQueue.main.addOperation() {
                ...
                case .denied:
                    alertTitle = NSLocalizedString("Speech Recognition", comment: "Speech Recognition")
                    alertMessage = NSLocalizedString("Kore needs access to your iPhone’s speech recognition. Tap Settings and turn on Speech Recognition.", comment: "Kore needs access to your iPhone’s speech recognition. Tap Settings and turn on Speech Recognition.")
                    settings = true
