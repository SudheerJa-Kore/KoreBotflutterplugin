...
public class KRELineChartViewCell: UITableViewCell {
    // MARK: - properties
    ...
    lazy var templateView: KRELineChartView = {
        let templateView = KRELineChartView(frame: .zero)
