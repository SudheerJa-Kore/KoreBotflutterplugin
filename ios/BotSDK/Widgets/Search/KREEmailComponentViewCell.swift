//
//  KREEmailComponentViewCell.swift
//  KoreBotSDK
//
...
public class KREEmailComponentViewCell: UITableViewCell {
    // MARK: - properties
    let bundle = KREResourceLoader.shared.resourceBundle()
    lazy var templateView: KAEmailCardView = {
        let templateView = KAEmailCardView(frame: .zero)
