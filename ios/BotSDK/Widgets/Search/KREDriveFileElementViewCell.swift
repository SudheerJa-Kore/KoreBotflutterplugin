//
//  KREDriveFileElementViewCell.swift
//  KoreBotSDK
//
...
public class KREDriveFileElementViewCell: UITableViewCell {
    // MARK: - properties
    let bundle = KREResourceLoader.shared.resourceBundle()
    lazy var templateView: KREDriveFileTemplateView = {
        let templateView = KREDriveFileTemplateView(frame: .zero)
